                ...
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item">
                        <a href="carrinho.php" class="btn me-2"
                            ...
                            <img src="/img/carrinho.png" style="width: 24px; height: 24px;"> CARRINHO <span
                                id="cart-count" class="badge bg-dark ms-1">0</span>
                        </a>
                    </li>
    ...
    <main class="flex-grow-1">
        ...
        <section style="background: #FFA831; color: #ffffff;">
            <div class="container py-3">
                ...
                <p class="text-center mb-2">Escolha suas delícias favoritas!</p>
                <!-- Filtro de Categoria -->
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4">
                        <label for="category-filter-select" class="form-label text-white">Filtrar por Categoria:</label>
        ...
        <!-- SEÇÃO Pizzas -->
        <section id="pizzas-section" class="py-5 product-section">
            <div class="container">
                <h2 class="text-center mb-4 section-title" style="color: #FFA831;">Pizzas</h2>
                <div id="pizzas-container" class="row">
                    <!-- Cards de Pizzas serão inseridos aqui -->
                </div>
            </div>
        </section>

        <!-- SEÇÃO Hambúrgueres -->
        <section id="hamburguer-section" class="py-5 product-section bg-light"> <!-- Alternando bg para visual -->
            <div class="container">
                <h2 class="text-center mb-4 section-title" style="color: #FFA831;">Hambúrgueres & Wraps</h2>
                <div id="hamburguer-container" class="row">
                    <!-- Cards de Hambúrgueres e Wraps serão inseridos aqui -->
                </div>
            </div>
        </section>

        <!-- SEÇÃO Bebidas -->
        <section id="bebidas-section" class="py-5 product-section">
            <div class="container">
                <h2 class="text-center mb-4 section-title" style="color: #FFA831;">Bebidas & Sucos</h2>
                <div id="bebidas-container" class="row">
                    <!-- Cards de Bebidas serão inseridos aqui -->
                </div>
            </div>
        </section>

        <!-- SEÇÃO Sobremesas -->
        <section id="sobremesa-section" class="py-5 product-section bg-light"> <!-- Alternando bg para visual -->
            <div class="container">
                <h2 class="text-center mb-4 section-title" style="color: #FFA831;">Sobremesas</h2>
                <div id="sobremesa-container" class="row">
                    <!-- Cards de Sobremesas serão inseridos aqui -->
                </div>
            </div>
        </section>
